...
import { Home, TrendingUp, PieChart, Shield, Loader2 } from "lucide-react"
  ...
  const features = [
    {
      ...
      description: "Monitorea tu crédito con valores UVA actualizados diariamente",
    },
    {
      icon: PieChart,
      title: "Visualizaciones claras",
      description: "Gráficos intuitivos para entender tu progreso de pago",
    },
    {
      icon: Shield,
      title: "Datos sincronizados",
      description: "Tu información guardada de forma segura en la nube",
    },
  ]
